...
export const useRecentProjects = () => {
  return useDataWithFallback(
    ...
    demoData.getProjects().slice(0, 5),
    { fallbackOnError: true }
  );
};
...
export const useProjectStatusDistribution = () => {
  return useDataWithFallback(
    ...
    demoData.getProjectStatusDistribution(),
    { fallbackOnError: true }
  );
};
